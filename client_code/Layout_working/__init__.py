from ._anvil_designer import Layout_workingTemplate
from anvil import *
import anvil.server
...
class Layout_working(Layout_workingTemplate):
  ...
  def load_child_form(self, form_instance):
    ...
    self.outlined_card_3.add_component(
      form_instance, full_width_row=True, align="center"
    )  # Add the new form to the slot
