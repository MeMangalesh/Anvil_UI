from ._anvil_designer import Admin_copy_copyTemplate
from anvil import *
import anvil.server
import base64
import anvil.media
...
class Admin_copy_copy(Admin_copy_copyTemplate):
  ...
  def button_save_n_detect_click(self, **event_args):
    ...
    if file:
      ...
      if result:
        ...
        pothole_detected, potholes_count, processed_image_base64 = (
          result  # Unpacking tuple/list
        )
